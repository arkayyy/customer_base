...
import Tickets2 from "../pages/Tickets2";
  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: "orders2", element: <Orders2 /> },
        { path: "commisions", element: <Commision /> },
        { path: "services", element: <Services /> },
        { path: "services2", element: <Services2 /> },
        { path: "subscriptions2", element: <Subscription2 /> },
        { path: "invoices2", element: <Invoices2 /> },
        { path: "Tickets2", element: <Tickets2 /> },
